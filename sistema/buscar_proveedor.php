  ...
  ?>
    <div class="container">
     ...
     <a href="registro_proveedor.php" class="btn_new">Crea proveedor</a>
      <input class="form-control mr-sm-2" type="search" placeholder="Buscar " aria-label="Search" name="busqueda" id="busqueda" value="<?php echo $busqueda;  ?>">
